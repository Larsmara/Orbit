...
local function GetOrCreateProxyButton(originalBtn, parent)
    ...
    proxy:SetScript("OnEnter", function(self)
        ...
        -- Legacy button OnEnter scripts anchor to the GLOBAL GameTooltip; retarget its SetOwner so the tooltip follows the visible proxy, not the offscreen original.
